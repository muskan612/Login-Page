...
export default function Signup() {
  ...
  return (
    ...
    <div className='input0'>
        <lable forHtml="email" className="UserName">User name</lable>
      ...
      <div className='input2'>
        ...
        <input type="password" required pattern="(?=.*[a-z])(?=.*[^\w\*])(?=.*[A-Z]).{4,}" title="password must contain at least 4 characters including at least one uppercase, one lowercase letter and one special character." className="form-control" id="Enter your password" placeholder="Enter your password" />
      </div>
      <div className='input3'>
        <lable forHtml="password" className="password">Confirm Password</lable>
